...
import FetchFlatDetail from "./FetchFlatDetail";
    ...
    <div>
      <AuthProvider>
        ...
        <Routes>
         ...
         <Route exact path="/rooms/:slug" element={<RequireAuth><FetchFlatDetail/></RequireAuth>} />
         ...
         <Route exact path="/myflats" element={<RequireAuth><MyFlats/></RequireAuth>} />
