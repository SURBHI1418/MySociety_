    ...
    <div className="conatiner my-5"  >
       <div className="row">
         <div className="col-6" >
           ...
           <PersonalFlats flats={flats} loading={loading} status={'Available'}/>
         </div>
         <div className="col-6">
             <h3 style={{fontWeight: 'bold', color:"#a64848", fontSize: 25,}}>Flats Booked</h3>
             <PersonalFlats flats={flats} loading={loading} status={'Booked'}/>
         </div>
       </div>
     </div>
  )
