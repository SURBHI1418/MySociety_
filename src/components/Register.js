  ...
  return (
    <div className='container my-5 w-50' >
      <div className="card-body text-black">
        <h3 style={{fontWeight: 'bold', color:"#a64848", fontSize: 25,}}>User Registration</h3>
        <div className="row">
        ...
        <div className="d-flex justify-content-end pt-3">
          <button type="button" className="btn btn-warning btn-lg ms-2" onClick={RegisterUser} style={{backgroundColor:"#a64848" ,color:'white'}}>
            Submit Form
          </button>
        </div>
      </div>
